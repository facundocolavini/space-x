...
const $$search = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Busqueda de Lanzamientos" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Search", Search, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/root/space-x/src/components/react/Search.tsx", "client:component-export": "default", "data-astro-transition-scope": renderTransition($$result2, "mnedcbqo", fade({ duration: "2s" }), "") })} ${launches.length === 0 ? renderTemplate`${maybeRenderHead()}<h1 class="text-black text-2xl my-10">No hay resultados...</h1>` : renderTemplate`${renderComponent($$result2, "Launches", $$Launches, { "searchedLaunch": launches })}`}` })}`;
